...
app = FastAPI(
    title="VoyageAI Free Travel Searcher",
    version="5.0.0",
)
...
async def health():
    ...
    return {
        ...
        "mode": "free-verified-data",
        "gemini_requests_per_trip": 1,
        "grounding_tool": False,
    }
...
async def plan_trip(
    ...
    if (
        ...
        return JSONResponse(
            ...
            content={
                "success": False,
                "error": (
                    "Child age is required when "
                    "at least one child is traveling."
                ),
            },
        )
    ...
    try:
        ...
        plan = TravelAIEngine().generate_plan(
            payload.model_dump()
        )
